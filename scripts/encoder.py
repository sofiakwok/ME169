...
class Encoder:
    # Initialize.
    def __init__(self, chLA = 23, chLB = 25, chRA = 22, chRB = 24):
    ...
    def LArise(self, gpio, level, tick):
        self.lcount += -1 if self.LB else 1
        self.LA = True
    ...
    def LBrise(self, gpio, level, tick):
        self.lcount += 1 if self.LA else -1
        self.LB = True
    ...
    def RArise(self, gpio, level, tick):
        self.rcount += -1 if self.RB else 1
        self.RA = True
    ...
    def RBrise(self, gpio, level, tick):
        self.rcount += 1 if self.RA else -1
        self.RB = True
