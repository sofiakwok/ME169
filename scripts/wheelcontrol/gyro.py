...
class Gyro:
    ...
    def setscale(self, scale):
        ...
        # Report.
        print(
            "Setting gyro scale to %.3f rad/sec (%.0f deg/sec)"
    ...
    def calibrate(self, N=200):
        ...
        stdlim = 0.01
        print("Gyro offset %.3f rad/sec (std %.3f <= %.3f limit)" % (avg, std, stdlim))
        if std > stdlim:
    ...
    def readraw(self):
        ...
        value -= ((value & 0x8000) >> 15) * 0xFFFF

        # Check for saturation.
        saturated = (value > 32700) or (value < -32700)

        # Scale into rad/sec.
        omegaraw = (value / 32767) * self.scale
